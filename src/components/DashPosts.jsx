...
export default function DashPosts() {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_POST_SERVICE}/getposts`);
        ...
        <>
          <Table hoverable className="shadow-md">
            <Table.Head>
              ...
              <Table.HeadCell>Staff pick</Table.HeadCell>
